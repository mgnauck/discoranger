...
#ifndef __i386__
extern void FSOUND_Mixer_FPU_Ramp_C( int numsamples,void * mixptr,FSOUND_CHANNEL *cptr,int buffend );
#endif
#endif
...
void FSOUND_Mixer_FPU_Ramp(void *mixptr, int len, char returnaddress) 
{
  ...
  for (count = 0; count < 64; count++)
  {
    ...
    asm volatile(
      ...
      : "eax", "ecx", "edx", "edi", "esi");
#else
	FSOUND_Mixer_FPU_Ramp_C( mix_numsamples,mix_mixptr,cptr,mix_mixbuffend );
#endif
/*
#ifdef __ppc__
    asm volatile(
